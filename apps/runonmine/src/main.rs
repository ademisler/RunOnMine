...
use runonmine_connectors::{
    ...
    ManagedBinaryActivation, ManagedBinaryVersion, ReleaseChannel, ReleaseProvider, SecretValue,
    SignedReleaseResolver, VersionedBinaryStore, external_binary_pin_store,
